...
partial class Repo
{
    // EmitShape: FlatRow with nullable nested composite (flattened columns: 3)
    ...
    public partial async global::System.Threading.Tasks.Task<global::TestApp.OrderRow?> GetByIdAsync(int @id, global::System.Threading.CancellationToken @ct)
    {
        ...
        try
        {
            ...
            try
            {
                ...
                {
                    var __amountText_isNull = __reader.IsDBNull(1);
                    var __currency_isNull = __reader.IsDBNull(2);
                    if (__amountText_isNull && __currency_isNull)
                        __Total = null;
                    else if (__amountText_isNull || __currency_isNull)
                        ...
                        __Total = global::TestApp.Money.FromStorage(
