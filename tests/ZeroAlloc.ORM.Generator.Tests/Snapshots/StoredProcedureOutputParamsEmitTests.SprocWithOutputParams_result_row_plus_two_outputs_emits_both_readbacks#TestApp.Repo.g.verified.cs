...
partial class Repo
{
    ...
    public partial async global::System.Threading.Tasks.Task<(global::TestApp.OrderRow Result, int NewOrderId, global::System.Guid TraceId)> InsertAsync(int @customerId, int @newOrderId, global::System.Guid @traceId, global::System.Threading.CancellationToken @ct)
    {
        ...
        try
        {
            ...
            var __out_TraceId = (__p_traceId.Value! switch { global::System.Guid __v => __v, string __v => global::System.Guid.Parse(__v), byte[] { Length: 16 } __v => new global::System.Guid(__v), var __v => (global::System.Guid)__v });
