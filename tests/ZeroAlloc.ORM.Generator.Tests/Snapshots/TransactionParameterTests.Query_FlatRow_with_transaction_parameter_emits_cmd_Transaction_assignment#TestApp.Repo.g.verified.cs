...
partial class Repo
{
    ...
    public partial async global::System.Threading.Tasks.Task<global::TestApp.OrderRow?> ReadOrderAsync(int @id, global::System.Data.Async.IAsyncDbTransaction @tx, global::System.Threading.CancellationToken @ct)
    {
        ...
        try
        {
            ...
            __cmd.CommandText = "SELECT Id, CustomerId FROM Orders WHERE Id = @id";
