...
partial class Repo
{
    ...
    public partial async global::System.Threading.Tasks.Task<global::TestApp.OrderId> InsertOrderAsync(int @cust, decimal @total, global::System.Threading.CancellationToken @ct)
    {
        ...
        try
        {
            ...
            if (__result is null)
                throw new global::ZeroAlloc.ORM.ZeroAllocOrmMaterializationException("Identity command 'TestApp.Repo.InsertOrderAsync' returned no row, but its return type is the non-nullable 'TestApp.OrderId'. The SQL must return the identity value, for example through RETURNING, OUTPUT or SCOPE_IDENTITY().");
