...
partial class Repo
{
    ...
    public partial async global::System.Threading.Tasks.Task<global::TestApp.OrderRow?> GetByIdAsync(global::TestApp.OrderId @id, global::System.Threading.CancellationToken @ct)
    {
        ...
        try
        {
            ...
            __cmd.CommandText = "SELECT Id, Total FROM Orders WHERE Id = @id";
            ...
            try
            {
                return new global::TestApp.OrderRow(
                    new global::TestApp.OrderId(__reader.GetInt32(0)),
